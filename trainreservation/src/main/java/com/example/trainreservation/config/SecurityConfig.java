...
@EnableJpaRepositories(basePackageClasses = com.example.trainreservation.repo.UserRepo.class )
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception{
        httpSecurity.authorizeRequests()
                .antMatchers("/css/**","/fonts/**","/images/**","/js/**","/404/**","/login/**","/user-save","/role-save","/register/**","/confirm/**" ).permitAll()
